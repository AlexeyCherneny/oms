...
const create = (baseURL = `${hostURL}api/`) => {
  ...
  return {
    ...
    readProjectWorks: ({ projectId, params }) => api.get(`/projects/${projectId}/works?${params}`),
    updateProjectWork: ({ id, projectId, params }) => api.put(`projects/${projectId}/works/${id}`, params),
